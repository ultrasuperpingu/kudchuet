/* @ts-self-types="./chinese_checkers.d.ts" */
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 154, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./chinese_checkers_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chinese_checkers_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
