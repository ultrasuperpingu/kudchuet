...
pub(crate) static NEIGHBORS_HOUDS: [Board;14] = [
	Board(0), // 0
...
pub(crate) static NEIGHBORS_HARE: [Board;14] = [
	Board(0), // 0
	Board(0b00000000111000), // 1
	Board(0), // 2
...
impl Board {
	#[inline(always)]
	pub(crate) const fn column(index: u8) -> u8 {
		index / 3
	}
}
// 0 3-6-9  12
...
pub struct HareAndHounds {
	pub(crate) houds: Board,
	pub(crate) hare: u8,
	pub(crate) turn_and_count: u8
}
...
impl HareAndHounds {
	pub(crate) const MAX_MOVES: usize = 9;
	#[inline]
	...
	pub fn compute_hash(&self) -> u64 {
		...
		kudchuet::utils::splitmix64(hounds | hare | turn)
