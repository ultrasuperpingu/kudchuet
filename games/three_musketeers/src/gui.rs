...
impl BoardMove<ThreeMusketeers> for Move {
    ...
    fn handle_clicks_interaction(
        ...
        clicks: &[u16],
    ) -> kudchuet::common::gui::input_handler::MoveResult<ThreeMusketeers>
    where
        ...
        <ThreeMusketeers as minimax::Game>::M: BoardMove<ThreeMusketeers>,
    {
        ...
        if candidates.is_empty() {
            return kudchuet::common::gui::input_handler::MoveResult::Invalid;
        }
        ...
        if next_possible_clicks.is_empty() {
            ...
            return match exact_matches.len() {
                0 => kudchuet::common::gui::input_handler::MoveResult::Invalid,
                1 => kudchuet::common::gui::input_handler::MoveResult::Created {
                    mv: exact_matches[0],
                    highlights_played: clicks.to_owned(),
                },
                _ => kudchuet::common::gui::input_handler::MoveResult::ChoiceRequired {
                    candidates: exact_matches,
                },
            };
        }

        kudchuet::common::gui::input_handler::MoveResult::Incomplete {
