use eframe::egui;
use kudchuet::common::ai::AIEngine;
use kudchuet::common::bitboards::Bitboard6x5;
use kudchuet::common::{GameResult, Player, PlayerType, new_move_searcher};
use super::game::YoteMaterialEval;
use super::rules::{Yote, Move};
