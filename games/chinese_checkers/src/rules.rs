...
pub struct ChineseCheckers {
	pub(crate) red: ChineseCheckerBoard,
	pub(crate) blue: ChineseCheckerBoard,
	pub(crate) green: ChineseCheckerBoard,
	pub(crate) yellow: ChineseCheckerBoard,
	pub(crate) black: ChineseCheckerBoard,
	pub(crate) white: ChineseCheckerBoard,
	pub(crate) nb_players: u8,
	pub(crate) hash: u64,
	pub(crate) turn: ChineseCheckersPlayer
}
...
mod tests {
	...
	use crate::bitboard::ChineseCheckerBoard;
	use kudchuet::common::{GameResult, gui::BoardGame};
	#[test]
	fn test_display() {
