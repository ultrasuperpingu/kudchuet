...
use crate::cards::{playing_cards32::PlayingCard32, playing_cards54::PlayingCard54};

use crate::gui::DrawablePlayingCard;
	...
	fn card_texture(&self) -> egui::ImageSource<'_> {
		match self {
			...
			PlayingCard32::QueenOfDiamonds => {
				include_image!("../../cards/Queen_of_diamonds_fr.svg")
			}
