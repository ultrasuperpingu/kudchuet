...
impl Bitboard5x5 {
	...
	const NEIGHBORS_BAGH_CHAL: [Bitboard5x5;Bitboard5x5::NB_SQUARES] = Self::generate_neighbors_bagh_chal_table();
	const TIGER_CAPTURES: [CaptureList;Bitboard5x5::NB_SQUARES] = Self::generate_tiger_capture_table();
}
#[derive(Clone,Copy)]
