...
use super::{Color, Square, Piece, CastlingRights, Move};


use crate::common::{GameResult, bitboards::Bitboard8x8};
...
impl ChessBoard {
	...
	#[inline]
	pub fn status(&self) -> crate::common::GameResult {
		if self.turn() == Color::Black {
			let no_legal_moves = self.legal_moves_template::<false>().is_empty();
			if !no_legal_moves {
				return crate::common::GameResult::OnGoing;
			}
